...
def button_equal():
    ...
    if f_num=="addition":
        e.insert(0,f_num + int(second_number))
    if f_num=="subtraction":
        e.insert(0,f_num - int(second_number))
    if f_num=="multiplication":
        e.insert(0,f_num * int(second_number))
    if f_num=="division":
        e.insert(0,f_num / int(second_number))
...
button_division=Button(root, text="-", padx=39, pady=20,command=button_sub)
button_division=Button(root, text="*", padx=39, pady=20,command=button_multi)
